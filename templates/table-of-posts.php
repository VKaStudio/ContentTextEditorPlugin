...
<table>
	...
	<tr>
		<td></td>
		<td><div class="replace-form"><?php render_replace_form('post_title', $oldKeyword ?? $keyword) ?></div></td>
		<td><div class="replace-form"><?php render_replace_form('post_content', $oldKeyword ?? $keyword) ?></div></td>
		<td><div class="replace-form"><?php render_replace_form('_yoast_wpseo_title', $oldKeyword ?? $keyword) ?></div></td>
		<td><div class="replace-form"><?php render_replace_form('_yoast_wpseo_metadesc', $oldKeyword ?? $keyword) ?></div></td>
	</tr>
